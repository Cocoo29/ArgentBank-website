...
function UserHeader() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      // Gére les erreurs de mise à jour du profil ici
    }
  }
  ...
  // Si le mode d'édition est désactivé,  ça affichera le nom et le prénom actuels
  if (!editButton) {
    return (
    ...
    // Si le mode d'édition est activé, il affichera le formulaire d'édition
    return (
      <div className="header">
